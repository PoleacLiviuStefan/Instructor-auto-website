...
const CardHero = ({ logo, title, details, slider }) => {
  return (
    <div className="flex rounded-xl flex-col items-center bg-gradient-to-b from-slate-600 to-slate-800 w-[22rem] h-[13rem] mt-[2rem] lg:mt-0 text-white bg-slate-800 drop-shadow-2xl cursor-pointer shadow-[5px_5px_38px_5px_rgba(0,0,0,0.72)]">
